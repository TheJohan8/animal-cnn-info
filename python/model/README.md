Important: Avoid manual input normalization, as the TensorFlow model already includes a Rescaling(1./255) layer immediately after the input layer.
...
Warning: This model is not highly accurate and is intended primarily for educational purposes.
